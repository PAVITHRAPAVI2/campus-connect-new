...
import '../../Pages/Student/student style/Landing.css';
import landingbg from "../../assets/landingbgimag.png";
        ...
        <div className="landing-page">
            ...
            <div className="hero">
                ...
                >
                    ...
                    <p>
                        Join Campus Connect to discover groups, clubs, and events that match
                        your interests. Make new friends and stay informed about campus
                        life.
                    </p>
            ...
            <div className="features-section">
                ...
                <p>
                    Campus Connect offers a range of features designed to enhance your
                    college experience. Connect with peers, explore groups and clubs, and
                ...
                <div className="features-grid">
                    ...
                    <div className="feature-box">
                        ...
                        <p>
                            Discover student organizations and join activities that align with
                            your hobbies.
                        </p>
                    </div>
                    <div className="feature-box">
